...
typedef struct _sock_ops_t {
	...
	net_err_t (*setopt)(struct _sock_t* sock,  int level, int optname, const void * optval, int optlen);
	net_err_t (*bind)(struct _sock_t* sock, const struct x_sockaddr* addr, x_socklen_t len);
	net_err_t (*connect)(struct _sock_t* sock, const struct x_sockaddr* addr, x_socklen_t len);
	net_err_t(*send)(struct _sock_t* sock, const void* buf, size_t len, int flags, ssize_t * result_len);
	net_err_t(*recv)(struct _sock_t* sock, void* buf, size_t len, int flags, ssize_t * result_len);
    net_err_t (*listen) (struct _sock_t *sock, int backlog);
    net_err_t (*accept)(struct _sock_t *sock, struct x_sockaddr* addr, x_socklen_t* len, struct _sock_t ** client);
