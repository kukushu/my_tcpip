...
ssize_t x_sendto(int sockfd, const void* buf, size_t len, int flags, const struct x_sockaddr* dest, x_socklen_t dest_len);
ssize_t x_recvfrom(int sockfd, void* buf, size_t len, int flags, struct x_sockaddr* src, x_socklen_t* src_len);
